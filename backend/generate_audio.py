...
from app.data.c1_lessons import C1_LESSONS
from app.data.c2_lessons import C2_LESSONS
from app.data.writing_exercises import WRITING_EXERCISES
from app.data.a1_final_test import A1_FINAL_TEST_QUESTIONS

# Combine all lessons (A1 + A2 + B1 + B2 + C1 + C2)
ALL_LESSONS = A1_LESSONS + A1_LESSONS_PART2 + A1_LESSONS_PART3 + A1_LESSONS_PART4 + A2_LESSONS + A2_LESSONS_PART2 + A2_LESSONS_PART3 + A2_LESSONS_PART4 + B1_LESSONS + B1_LESSONS_PART2 + B1_LESSONS_PART3 + B2_LESSONS + C1_LESSONS + C2_LESSONS
