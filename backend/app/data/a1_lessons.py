...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu riječ", "content": {"words": ["zdravo", "hvala", "molim", "dovidenja"]}, "answer": "dovidenja", "hint": "Ispravno je 'doviđenja' — nedostaje dijakritički znak 'đ'"},
            ...
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["jutro", "vece", "noć", "dan"]}, "answer": "vece", "hint": "Ispravno je 'veče' — nedostaje dijakritički znak 'č'"},
            ...
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["zdravo", "cao", "zbogom", "doviđenja"]}, "answer": "cao", "hint": "Ispravno je 'ćao' — nedostaje dijakritički znak 'ć'"},
            ...
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["hvala", "molim", "zdravo", "havla"]}, "answer": "havla", "hint": "Ispravno je 'hvala' — slova 'h' i 'v' su zamijenjena mjestima"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["profesor", "student", "ucenik", "prijatelj"]}, "answer": "ucenik", "hint": "Ispravno je 'učenik' — nedostaje dijakritički znak 'č'"},
            ...
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["lijepo", "dobro", "lose", "odlično"]}, "answer": "lose", "hint": "Ispravno je 'loše' — nedostaje dijakritički znak 'š'"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu riječ", "content": {"words": ["jedan", "dva", "tri", "cetiri"]}, "answer": "cetiri", "hint": "Ispravno je 'četiri' — nedostaje dijakritički znak 'č'"},
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["jedan", "dva", "tri", "cetri"]}, "answer": "cetri", "hint": "Ispravno je 'četiri' — nedostaje dijakritički znak 'č' i slovo 'i' u sredini"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["pet", "sest", "sedam", "osam"]}, "answer": "sest", "hint": "Ispravno je 'šest' — nedostaje dijakritički znak 'š'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["devet", "deset", "jedanaest", "dvanaes"]}, "answer": "dvanaes", "hint": "Ispravno je 'dvanaest' — nedostaje završno slovo 't'"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["prvi", "drugi", "treci", "četvrti"]}, "answer": "treci", "hint": "Ispravno je 'treći' — nedostaje dijakritički znak 'ć'"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["petnaest", "sesnaest", "sedamnaest", "osamnaest"]}, "answer": "sesnaest", "hint": "Ispravno je 'šesnaest' — nedostaje dijakritički znak 'š'"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["dvadeset", "trideset", "pedeset", "sezdeset"]}, "answer": "sezdeset", "hint": "Ispravno je 'šezdeset' — nedostaje dijakritički znak 'š'"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["dvanaest", "trinaest", "cetrnaest", "petnaest"]}, "answer": "cetrnaest", "hint": "Ispravno je 'četrnaest' ili 'četrnaest' — nedostaje dijakritički znak 'č' ispred 'e'"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["peta", "sesta", "sedma", "osma"]}, "answer": "sesta", "hint": "Ispravno je 'šesta' — redni broj ženskog roda za 6, nedostaje dijakritički znak 'š'"},
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["nula", "jedan", "dvoje", "cetero"]}, "answer": "cetero", "hint": "Ispravno je 'četvero' — zbirni broj za 4, nedostaje dijakritički znak 'č'"},
            ...
            {"id": 51, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imam deset minuta.", "On je prvi na listi.", "Ona je treća u redu.", "To su dvajest godina."]}, "answer": "To su dvajest godina.", "hint": "Ispravno je 'dvadeset' — bez slova 'j'"},
            ...
            {"id": 55, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imam sedamnaest godina.", "On ima devetnaest godina.", "Kupio sam osamnaest knjiga.", "Vidio sam šesnaes filmova."]}, "answer": "Vidio sam šesnaes filmova.", "hint": "Ispravno je 'šesnaest' — broj 16 se piše s 't' na kraju"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu riječ", "content": {"words": ["crvena", "plava", "zelena", "zuta"]}, "answer": "zuta", "hint": "Ispravno je 'žuta' — nedostaje dijakritički znak 'ž'"},
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["plav", "crven", "zelen", "zjut"]}, "answer": "zjut", "hint": "Ispravno je 'žut' — pridjevi muškog roda, slova 'j' i 'ž' su zamijenjena"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["bijela", "crna", "siva", "smeda"]}, "answer": "smeda", "hint": "Ispravno je 'smeđa' — nedostaje dijakritički znak 'đ' umjesto 'd'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["narandzasta", "ljubičasta", "roza", "tirkizna"]}, "answer": "narandzasta", "hint": "Ispravno je 'narandžasta' — nedostaje dijakritički znak 'ž' umjesto 'z'"},
            ...
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["bijeli", "crni", "sivi", "ljubicasti"]}, "answer": "ljubicasti", "hint": "Ispravno je 'ljubičasti' — nedostaje dijakritički znak 'č'"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["tamnozelena", "tamnocrvena", "tamnoplava", "tamnozuta"]}, "answer": "tamnozuta", "hint": "Ispravno je 'tamnožuta' — nedostaje dijakritički znak 'ž'"},
            ...
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["smed", "crn", "bijel", "plav"]}, "answer": "smed", "hint": "Ispravno je 'smeđ' — nedostaje dijakritički znak 'đ'"},
