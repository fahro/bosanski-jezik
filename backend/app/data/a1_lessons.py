...
""",
        ...
        "exercises": [
            ...
            {"id": 11, "type": "matching", "instruction": "Povežite pozdrave sa odgovarajućim prijevodom", "content": {"pairs": [["Dobro jutro", "Good morning"], ["Dobar dan", "Good afternoon"], ["Dobro veče", "Good evening"], ["Laku noć", "Good night"]]},"answer": "correct_pairs", "hint": "Razmislite kada koristite svaki pozdrav"},
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite riječ koja ne pripada grupi", "content": {"words": ["zdravo", "doviđenja", "ćao", "kako"]}, "answer": "kako", "hint": "'Kako' je upitna riječ, a ne pozdrav — ostale tri su pozdravi"},
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["dobar", "dobro", "dobra", "dobar žena"]}, "answer": "dobar žena", "hint": "Ispravno je 'dobra žena' — pridjev mora biti ženskog roda jer 'žena' je ženski rod"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite riječ koja ne pripada grupi", "content": {"words": ["ja", "ti", "on", "smo"]}, "answer": "smo", "hint": "'Smo' je oblik glagola 'biti' (mi smo), a ne lična zamjenica — ostale tri su lične zamjenice"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["sam", "si", "je", "smi"]}, "answer": "smi", "hint": "Ispravno je 'smo' — oblici glagola biti: sam, si, je, smo, ste, su"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno upotrebljenu riječ", "content": {"words": ["zovem se", "zoveš se", "zove se", "zvam se"]}, "answer": "zvam se", "hint": "Ne postoji oblik 'zvam se' u bosanskom — ispravno je 'zovem se' (ja), 'zoveš se' (ti), 'zove se' (on/ona)"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["zovem", "zoveš", "zove", "zovimo"]}, "answer": "zovimo", "hint": "Ispravno je 'zovemo' — prva lica množine glagola zvati"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite riječ koja ne pripada grupi", "content": {"words": ["ime", "prezime", "adresa", "lijepo"]}, "answer": "lijepo", "hint": "'Lijepo' je prilog (odgovara na pitanje 'kako'), a ne lični podatak — ostale tri su lični podaci"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno upotrebljenu kombinaciju", "content": {"words": ["dobar čovjek", "dobra žena", "dobro dijete", "dobar knjiga"]}, "answer": "dobar knjiga", "hint": "'Knjiga' je ženskog roda, pa pridjev mora biti ženskog roda — ispravno je 'dobra knjiga'"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["Bosna", "Sarajevo", "Hercegovina", "Banja luka"]}, "answer": "Banja luka", "hint": "Ispravno je 'Banja Luka' — oba dijela naziva grada pišu se velikim slovom"},
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite pogrešno upotrebljenu frazu", "content": {"words": ["drago mi je", "lijepo mi je", "zadovoljstvo mi je", "svejedno mi je"]}, "answer": "svejedno mi je", "hint": "'Svejedno mi je' znači 'it's all the same to me' — ne koristi se pri upoznavanju; ispravno je 'Drago mi je'"},
            {"id": 49, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Dobro jutro, kako ste?", "Ja smo Amira.", "On je student.", "Mi smo iz Sarajeva."]}, "answer": "Ja smo Amira.", "hint": "Za 'ja' koristimo 'sam' — ispravno je 'Ja sam Amira'"},
            {"id": 50, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Zdravo, zovem se Haris.", "Odakle si ti?", "Ona je iz Mostara.", "Ti smo učenik."]}, "answer": "Ti smo učenik.", "hint": "Za 'ti' koristimo 'si' — ispravno je 'Ti si učenik'"},
            {"id": 51, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Dobar dan, gospođo.", "Vi ste profesor.", "Mi je iz Bosne.", "Oni su moji prijatelji."]}, "answer": "Mi je iz Bosne.", "hint": "Za 'mi' koristimo 'smo' — ispravno je 'Mi smo iz Bosne'"},
            {"id": 52, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Kako se zoveš?", "Ja sam dobro, hvala.", "On su visok.", "Ona je lijepa."]}, "answer": "On su visok.", "hint": "Za 'on' koristimo 'je' — ispravno je 'On je visok'"},
            {"id": 53, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Drago mi je.", "Ja sam student.", "Ona si nastavnica.", "Vi ste iz Travnika."]}, "answer": "Ona si nastavnica.", "hint": "Za 'ona' koristimo 'je' — ispravno je 'Ona je nastavnica'"},
            {"id": 54, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Hvala lijepo.", "Nema na čemu.", "Molim te, pomozi mi.", "Oni je ovdje."]}, "answer": "Oni je ovdje.", "hint": "Za 'oni' koristimo 'su' — ispravno je 'Oni su ovdje'"},
            {"id": 55, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Dobro veče, gospod.", "Kako ste vi?", "Ja sam umoran.", "Laku noć svima."]}, "answer": "Dobro veče, gospod.", "hint": "Ispravno je 'gospodine' u vokativu — 'Dobro veče, gospodine'"},
            {"id": 56, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Odakle ste vi?", "Ja jesam iz Zenice.", "On je Bosanac.", "Mi smo studenti."]}, "answer": "Ja jesam iz Zenice.", "hint": "U kratkoj formi koristimo 'sam' — ispravno je 'Ja sam iz Zenice'"},
            {"id": 57, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Zovem se Amina.", "Moje ime je Kenan.", "Ja sam dobar.", "Vi su studenti."]}, "answer": "Vi su studenti.", "hint": "Za 'vi' koristimo 'ste' — ispravno je 'Vi ste studenti'"}
        ],
        "quiz": [
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite broj koji ne pripada grupi", "content": {"words": ["jedan", "dva", "tri", "četvrti"]}, "answer": "četvrti", "hint": "'Četvrti' je redni broj (ordinal), a ne glavni broj (cardinal) — ostala tri su glavni brojevi"},
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno upotrebljenu kombinaciju", "content": {"words": ["jedna knjiga", "dva brata", "tri sestre", "četiri djece"]}, "answer": "četiri djece", "hint": "Uz 'djeca' (množinska imenica) koriste se zbirni brojevi — ispravno je 'četvero djece', ne 'četiri djece'"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite broj koji ne pripada grupi", "content": {"words": ["pet", "šest", "sedam", "osma"]}, "answer": "osma", "hint": "'Osma' je redni broj ženskog roda (8th), a ne glavni broj — ispravno je 'osam'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno upotrebljenu riječ", "content": {"words": ["devet", "deset", "jedanaest", "dvanajest"]}, "answer": "dvanajest", "hint": "Ne postoji oblik 'dvanajest' — ispravno je 'dvanaest' (dva + na + est)"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite broj koji ne pripada grupi", "content": {"words": ["prvi", "drugi", "treća", "četvrti"]}, "answer": "treća", "hint": "'Treća' je ženskog roda, dok su 'prvi', 'drugi' i 'četvrti' muškog roda — ispravno je 'treći'"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite broj koji ne pripada grupi", "content": {"words": ["peta", "šesta", "sedma", "osam"]}, "answer": "osam", "hint": "'Osam' je glavni broj, dok su 'peta', 'šesta' i 'sedma' redni brojevi ženskog roda — ispravno bi bilo 'osma'"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite broj koji ne pripada grupi", "content": {"words": ["dvadeset", "trideset", "četrdeset", "pedeseto"]}, "answer": "pedeseto", "hint": "Ne postoji oblik 'pedeseto' kao broj — 'pedeseto' je redni broj srednjeg roda; ispravno je 'pedeset'"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite broj koji ne pripada nizu", "content": {"words": ["dvanaest", "trinaest", "četrnaest", "dvadeset"]}, "answer": "dvadeset", "hint": "'Dvadeset' (20) ne slijedi niz — ispravno je 'petnaest' (15) koji dolazi poslije četrnaest (14)"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno upotrebljenu kombinaciju", "content": {"words": ["imam jedan brat", "imam jednu sestru", "imam jedno dijete", "imam jednog prijatelja"]}, "answer": "imam jedan brat", "hint": "Nakon 'imam' dolazi akuzativ — 'brat' je nominativ; ispravno je 'imam jednog brata'"},
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite broj koji ne pripada grupi", "content": {"words": ["dvoje", "troje", "četvero", "pet"]}, "answer": "pet", "hint": "'Pet' je glavni broj, dok su 'dvoje', 'troje' i 'četvero' zbirni brojevi (za osobe/djece u grupi) — ispravno bi bilo 'petero'"},
            {"id": 49, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imam jednu sestru.", "On ima dva brata.", "Kupila sam pet jabuke.", "Vidio sam tri filma."]}, "answer": "Kupila sam pet jabuke.", "hint": "Iza broja pet koristimo genitiv množine — ispravno je 'pet jabuka'"},
            {"id": 50, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Ona ima dvanaest godina.", "Kupio sam tri knjige.", "Vidim dva djevojka.", "On ima šest kola."]}, "answer": "Vidim dva djevojka.", "hint": "Djevojka je ženskog roda — ispravno je 'dvije djevojke'"},
            {"id": 51, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imam deset minuta.", "On je prvi na listi.", "Ona je treća u redu.", "On ima dvadeset i jedna godina."]}, "answer": "On ima dvadeset i jedna godina.", "hint": "Uz 'dvadeset i jedan' imenica dolazi u akuzativu — ispravno je 'On ima dvadeset i jednu godinu'"},
            {"id": 52, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Koliko imaš godina?", "Imam petnaest godina.", "On ima jednog brata.", "Ona ima jedna sestra."]}, "answer": "Ona ima jedna sestra.", "hint": "Nakon 'ima' dolazi akuzativ — ispravno je 'Ona ima jednu sestru'"},
            {"id": 53, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Kuća ima pet soba.", "Vidim tri studenta.", "Imam dva jabuke.", "On čita šest knjiga."]}, "answer": "Imam dva jabuke.", "hint": "Jabuka je ženskog roda — ispravno je 'Imam dvije jabuke'"},
            {"id": 54, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Treći sat je matematika.", "Prva lekcija je laka.", "Drugi dan je utorak.", "Četvrti čas su engleski."]}, "answer": "Četvrti čas su engleski.", "hint": "Čas je jednina — ispravno je 'Četvrti čas je engleski'"},
            {"id": 55, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imam sedamnaest godina.", "On ima devetnaest godina.", "Ona ima osamnaest prijatelja.", "Vidio sam dvanaest filma."]}, "answer": "Vidio sam dvanaest filma.", "hint": "Uz 'dvanaest' (broj 12+) imenica ide u genitivu množine — ispravno je 'dvanaest filmova'"},
            {"id": 56, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Ima li mjesta?", "Da, ima četiri mjesta.", "Molim jedan karte.", "Hvala, to je sve."]}, "answer": "Molim jedan karte.", "hint": "Karta je ženskog roda — ispravno je 'Molim jednu kartu'"},
            {"id": 57, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imamo deset učenika.", "U razredu je dvadeset stolova.", "Vidim pet dječak.", "Ona broji do dvanaest."]}, "answer": "Vidim pet dječak.", "hint": "Iza broja pet koristimo genitiv množine — ispravno je 'pet dječaka'"}
        ],
        "quiz": [
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite boju koja ne pripada grupi", "content": {"words": ["crvena", "plava", "zelena", "crven"]}, "answer": "crven", "hint": "'Crven' je muškog roda, dok su 'crvena', 'plava' i 'zelena' ženskog roda — ispravno je 'crvena'"},
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite boju koja ne pripada grupi", "content": {"words": ["plavo", "crveno", "zeleno", "žuta"]}, "answer": "žuta", "hint": "'Žuta' je ženskog roda, dok su 'plavo', 'crveno' i 'zeleno' srednjeg roda — ispravno je 'žuto'"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite boju koja ne pripada grupi", "content": {"words": ["bijela", "crna", "siva", "smeđi"]}, "answer": "smeđi", "hint": "'Smeđi' je muškog roda, dok su 'bijela', 'crna' i 'siva' ženskog roda — ispravno je 'smeđa'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite boju koja ne pripada grupi", "content": {"words": ["narandžasta", "ljubičasta", "ružičasta", "tirkizni"]}, "answer": "tirkizni", "hint": "'Tirkizni' je muškog roda, dok su ostale tri boje ženskog roda — ispravno je 'tirkizna'"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["plavo", "crvena", "zeleno", "žuto"]}, "answer": "crvena", "hint": "Ispravno je 'crveno' — prilog/pridjev srednjeg roda mora biti 'crveno', ne 'crvena' (ženski rod)"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite boju koja ne pripada grupi", "content": {"words": ["bijeli", "crni", "sivi", "ljubičastom"]}, "answer": "ljubičastom", "hint": "'Ljubičastom' je instrumental/dativni oblik, dok su 'bijeli', 'crni' i 'sivi' nominativ muškog roda — ispravno je 'ljubičasti'"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite boju koja ne pripada grupi", "content": {"words": ["tamnozelena", "tamnocrvena", "tamnoplava", "tamno žuta"]}, "answer": "tamno žuta", "hint": "Složene boje pišu se kao jedna riječ — ispravno je 'tamnožuta' (bez razmaka)"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["crvena", "zelena", "plavi", "žuta"]}, "answer": "plavi", "hint": "Ispravno je 'plava' — boja ženskog roda mora biti 'plava', ne 'plavi' (muški rod)"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite boju koja ne pripada grupi", "content": {"words": ["smeđ", "crn", "bijel", "zelena"]}, "answer": "zelena", "hint": "'Zelena' je ženskog roda, dok su 'smeđ', 'crn' i 'bijel' osnova muškog roda — ispravno je 'zelen'"},
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["naranđasta", "ljubičasta", "ružičasta", "tirkizna"]}, "answer": "naranđasta", "hint": "Ispravno je 'narandžasta' — piše se 'ndž', ne 'nđ'"},
            {"id": 49, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Auto je crven.", "Kuća je bijela.", "More je plava.", "Drvo je zeleno."]}, "answer": "More je plava.", "hint": "More je srednjeg roda — ispravno je 'More je plavo'"},
            {"id": 50, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Moja haljina je crvena.", "Njego auto je plavo.", "Njen šal je zelen.", "Njegovo odijelo je sivo."]}, "answer": "Njego auto je plavo.", "hint": "Ispravno je 'Njegovo auto' — posvojna zamjenica muškog roda"},
            {"id": 51, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Stol je smeđi.", "Zid je bijel.", "Stolica su žuta.", "Tepih je crven."]}, "answer": "Stolica su žuta.", "hint": "Stolica je jednina ženskog roda — ispravno je 'Stolica je žuta'"},
            {"id": 52, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Volim zelenu boju.", "On nosi plavi kaput.", "Ima crnu maček.", "Ona nosi bijelu haljinu."]}, "answer": "Ima crnu maček.", "hint": "Mačak je muškog roda — ispravno je 'Ima crnog mačka'"},
            {"id": 53, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Nebo je danas plavo.", "Lišće je zeleno.", "Ruža je crveni.", "Snijeg je bijel."]}, "answer": "Ruža je crveni.", "hint": "Ruža je ženskog roda — ispravno je 'Ruža je crvena'"},
            {"id": 54, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Koji je tvoj omiljeni boja?", "Volim plavu boju.", "Moja omiljena boja je zelena.", "Crvena je lijepa boja."]}, "answer": "Koji je tvoj omiljeni boja?", "hint": "Boja je ženskog roda — ispravno je 'Koja je tvoja omiljena boja?'"},
            {"id": 55, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imam crnu torbu.", "On nosi sivi šešir.", "Ona ima ljubičastu haljinu.", "Kupio sam zelenoga kaput."]}, "answer": "Kupio sam zelenoga kaput.", "hint": "Kaput je muškog roda u akuzativu — ispravno je 'Kupio sam zeleni kaput'"},
            {"id": 56, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Tamno plava je moja omiljena.", "Svjetlo zelena je lijepa.", "On nosi narandžasto majicu.", "Bijela i crna su suprotnosti."]}, "answer": "On nosi narandžasto majicu.", "hint": "Majica je ženskog roda — ispravno je 'On nosi narandžastu majicu'"},
            {"id": 57, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Plava boja smiruje.", "Crvena boja uzbuđuje.", "Zelena boja opušta.", "Žut boja je vesela."]}, "answer": "Žut boja je vesela.", "hint": "Boja je ženskog roda — ispravno je 'Žuta boja je vesela'"}
        ],
        "quiz": [
