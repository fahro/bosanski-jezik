...
""",
        ...
        "exercises": [
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["dobar", "dobro", "dobra", "dobarr"]}, "answer": "dobarr", "hint": "Ispravno je 'dobar' — samo jedno 'r' na kraju"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["jutro", "veče", "noć", "daan"]}, "answer": "daan", "hint": "Ispravno je 'dan' — samo jedno 'a'"},
            ...
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["ja", "ti", "ono", "vi"]}, "answer": "ono", "hint": "Lična zamjenica trećeg lica jednine je 'on' (m.r.) ili 'ona' (ž.r.) — 'ono' se koristi za srednji rod, ali ne kao osnovna lična zamjenica"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["zovem", "zoviš", "zove", "zovimo"]}, "answer": "zovimo", "hint": "Ispravno je 'zovemo' — prva lica množine glagola zvati"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["hvala", "molim", "zdravo", "dovidđenja"]}, "answer": "dovidđenja", "hint": "Ispravno je 'doviđenja' — samo jedno 'd' i jedno 'đ'"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["profesor", "student", "učeniik", "prijatelj"]}, "answer": "učeniik", "hint": "Ispravno je 'učenik' — samo jedno 'i'"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["Bosna", "Sarajevo", "Hercegovina", "Mosttar"]}, "answer": "Mosttar", "hint": "Ispravno je 'Mostar' — samo jedno 't'"},
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["lijepo", "dobro", "loše", "losso"]}, "answer": "losso", "hint": "Ispravno je 'loše' — prilog za loše stanje"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["jedan", "dva", "tri", "četerri"]}, "answer": "četerri", "hint": "Ispravno je 'četiri' — bez dvostrukog 'r'"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["pet", "šest", "sedam", "ossam"]}, "answer": "ossam", "hint": "Ispravno je 'osam' — samo jedno 's'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["devet", "deset", "jedanest", "dvanaest"]}, "answer": "jedanest", "hint": "Ispravno je 'jedanaest' — broj 11"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["prvi", "drugi", "treći", "čertvi"]}, "answer": "čertvi", "hint": "Ispravno je 'četvrti' — redni broj za 4"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["petnaest", "šesnaest", "sedamnaest", "osamnaes"]}, "answer": "osamnaes", "hint": "Ispravno je 'osamnaest' — broj 18"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["dvadeset", "trideset", "šezdeset", "peddesset"]}, "answer": "peddesset", "hint": "Ispravno je 'pedeset' — broj 50"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["dvanaest", "trinajest", "četrnaest", "petnaest"]}, "answer": "trinajest", "hint": "Ispravno je 'trinaest' — broj 13"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["peta", "šesta", "sedma", "osmma"]}, "answer": "osmma", "hint": "Ispravno je 'osma' — redni broj ženskog roda za 8"},
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["nula", "jedan", "dvoje", "trojje"]}, "answer": "trojje", "hint": "Ispravno je 'troje' — zbirni broj"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["plav", "crven", "zeleen", "žut"]}, "answer": "zeleen", "hint": "Ispravno je 'zelen' — pridjevi muškog roda za boju zelenu"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["bijela", "crna", "siva", "smeda"]}, "answer": "smeda", "hint": "Ispravno je 'smeđa' — boja smeđa se piše s 'đ'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["narandžasta", "ljubičasta", "rooza", "tirkizna"]}, "answer": "rooza", "hint": "Ispravno je 'ružičasta' ili 'roza' — jedno 'o'"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["plavo", "crveno", "zeleno", "žutta"]}, "answer": "žutta", "hint": "Ispravno je 'žuto' — samo jedno 't'"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["bijeli", "crni", "siivi", "plavi"]}, "answer": "siivi", "hint": "Ispravno je 'sivi' — samo jedno 'i' u sredini"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["tamnozelena", "tamnocrvena", "tamnoplava", "tamnocrno"]}, "answer": "tamnocrno", "hint": "Pridjevi boje za opis moraju se slagati po rodu — ako opisujemo ženski rod, treba 'tamnocrna'"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["crvena", "zelena", "plava", "žutna"]}, "answer": "žutna", "hint": "Ispravno je 'žuta' — pridjevi boje: crvena, zelena, plava, žuta"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["smeđ", "crn", "biiel", "plav"]}, "answer": "biiel", "hint": "Ispravno je 'bijel' — samo jedno 'i'"},
            {"id": 48, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["naranđasta", "ljubičasta", "ružičasta", "tirkizna"]}, "answer": "naranđasta", "hint": "Ispravno je 'narandžasta' — boja naranče"},
