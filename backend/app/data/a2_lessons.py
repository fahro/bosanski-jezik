...
""",
        ...
        "exercises": [
            {"id": 1, "type": "fill_blank", "instruction": "Popunite prazninu odgovarajućom riječju", "content": {"sentence": "_____ bih naručiti ćevape.", "options": ["Želio", "Želim", "Želi", "Želite"]}, "answer": "Želio", "hint": "Koristite kondicionalni oblik za muškarce"},
            ...
            {"id": 4, "type": "fill_blank", "instruction": "Popunite prazninu kondicionalnim oblikom", "content": {"sentence": "Mi _____ sto za četvoro.", "options": ["željeli bismo", "želimo", "željeli bi", "želio bih"]}, "answer": "željeli bismo", "hint": "Kondicionalni oblik za 'mi'"},
            {"id": 5, "type": "matching", "instruction": "Povežite riječi sa značenjima", "content": {"pairs": [["jelovnik", "menu"], ["račun", "bill"], ["napojnica", "tip"], ["predjelo", "appetizer"], ["konobar", "waiter"]]}, "answer": "correct_pairs", "hint": "Razmislite o situaciji u restoranu"},
            {"id": 6, "type": "matching", "instruction": "Povežite bosanske fraze sa engleskim", "content": {"pairs": [["Prijatno!", "Enjoy your meal!"], ["Izvolite", "Here you go"], ["Račun, molim", "The bill, please"], ["Šta preporučujete?", "What do you recommend?"]]}, "answer": "correct_pairs", "hint": "Uobičajene fraze u restoranu"},
            {"id": 7, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "The bill, please!"}, "answer": "Račun, molim!", "hint": "Koristite riječ 'račun'"},
            {"id": 8, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "I would like to order ćevapi."}, "answer": "Želio bih naručiti ćevape.", "hint": "Koristite kondicionalni oblik"},
            {"id": 9, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "What is the house specialty?"}, "answer": "Koji je specijalitet kuće?", "hint": "Specijalitet = specialty"},
            {"id": 10, "type": "sentence_order", "instruction": "Poredajte riječi u pravilnu rečenicu", "content": {"words": ["bih", "kafu", "Željela", "bosansku", "jednu"]}, "answer": "Željela bih jednu bosansku kafu.", "hint": "Počnite s 'Željela'"}
        ],
        "quiz": [
...
""",
        ...
        "exercises": [
            {"id": 1, "type": "fill_blank", "instruction": "Popunite prazninu komparativom", "content": {"sentence": "Ova jakna je _____ od one. (skup)", "options": ["skupa", "skuplja", "najskuplja", "skupo"]}, "answer": "skuplja", "hint": "Koristite komparativ pridjeva 'skup'"},
            ...
            {"id": 6, "type": "matching", "instruction": "Povežite suprotne pridjeve", "content": {"pairs": [["skupo", "jeftino"], ["veliko", "malo"], ["dobro", "loše"], ["bolje", "gore"]]}, "answer": "correct_pairs", "hint": "Razmislite o suprotnostima"},
            {"id": 7, "type": "matching", "instruction": "Povežite riječi sa značenjima", "content": {"pairs": [["cijena", "price"], ["popust", "discount"], ["kusur", "change"], ["blagajna", "cash register"], ["kabina", "fitting room"]]}, "answer": "correct_pairs", "hint": "Riječi za kupovinu"},
            {"id": 8, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "How much does this cost?"}, "answer": "Koliko ovo košta?", "hint": "Koristite 'koliko' i 'koštati'"},
            {"id": 9, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "Do you have a bigger size?"}, "answer": "Imate li veću veličinu?", "hint": "Veći = bigger"},
            {"id": 10, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "I'll take this one."}, "answer": "Uzeću ovo.", "hint": "Futur od 'uzeti'"},
            {"id": 11, "type": "sentence_order", "instruction": "Poredajte riječi u pravilnu rečenicu", "content": {"words": ["Imate", "popust", "li", "danas", "?"]}, "answer": "Imate li popust danas?", "hint": "Pitanje o popustu"}
        ],
        "quiz": [
...
""",
        ...
        "exercises": [
            ...
            {"id": 6, "type": "matching", "instruction": "Povežite suprotne pridjeve", "content": {"pairs": [["visok", "nizak"], ["pametan", "glup"], ["veseo", "tužan"], ["vrijedan", "lijen"], ["debeo", "mršav"]]}, "answer": "correct_pairs", "hint": "Razmislite o suprotnostima"},
            {"id": 7, "type": "matching", "instruction": "Povežite pridjeve sa značenjima", "content": {"pairs": [["ljubazan", "kind"], ["lijep", "beautiful"], ["pametan", "smart"], ["vrijedan", "hardworking"], ["lijen", "lazy"]]}, "answer": "correct_pairs", "hint": "Karakterne osobine"},
            {"id": 8, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "She is very beautiful and kind."}, "answer": "Ona je vrlo lijepa i ljubazna.", "hint": "Koristite ženski rod pridjeva"},
            {"id": 9, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "He is tall and thin."}, "answer": "On je visok i mršav.", "hint": "Visok = tall, mršav = thin"},
            {"id": 10, "type": "translate", "instruction": "Prevedite na bosanski", "content": {"text": "My brother is very smart."}, "answer": "Moj brat je vrlo pametan.", "hint": "Pametan = smart"},
            {"id": 11, "type": "sentence_order", "instruction": "Poredajte riječi u pravilnu rečenicu", "content": {"words": ["je", "Ona", "i", "vrijedna", "pametna"]}, "answer": "Ona je pametna i vrijedna.", "hint": "Počnite s 'Ona'"}
        ],
        "quiz": [
