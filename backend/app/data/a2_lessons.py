...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["naruciti", "konobar", "jelovnik", "račun"]}, "answer": "naruciti", "hint": "Ispravno je 'naručiti' — nedostaje dijakritički znak 'č'"},
            {"id": 39, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["predjelo", "glavno jelo", "dezert", "napojnica"]}, "answer": "dezert", "hint": "Ispravno je 'desert' ili 'desertni kolač' — 'dezert' je engleska posuđenica pogrešno prilagođena; ispravno je 'slastica' ili 'desert'"},
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["rezervacija", "specijalitet", "preporučiti", "meniu"]}, "answer": "meniu", "hint": "Ispravno je 'meni' — pogrešan padežni nastavak, 'meniu' ne postoji u bosanskom"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["cevapi", "burek", "baklava", "pita"]}, "answer": "cevapi", "hint": "Ispravno je 'ćevapi' — nedostaju dijakritički znakovi 'ć'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["vino", "pivo", "sok", "mineralnu"]}, "answer": "mineralnu", "hint": "Ispravno je 'mineralnu vodu' ili samo 'mineralna' — koristi se akuzativ 'mineralnu' samo uz imenicu 'vodu'"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["tanjir", "casa", "viljuška", "nož"]}, "answer": "casa", "hint": "Ispravno je 'čaša' — nedostaju dijakritički znakovi 'č' i 'š'"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["sladak", "slan", "kiseo", "gork"]}, "answer": "gork", "hint": "Ispravno je 'gorak' — nedostaje samoglasnik 'a' između 'gor' i 'k'"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["hladna", "topla", "vruca", "svježa"]}, "answer": "vruca", "hint": "Ispravno je 'vruća' — nedostaje dijakritički znak 'ć'"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["čorba", "supa", "juha", "varvo"]}, "answer": "varvo", "hint": "Ispravno je 'varivo' — nedostaje slovo 'i' između 'var' i 'vo'"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["kuhinja", "restoran", "ascinica", "kafana"]}, "answer": "ascinica", "hint": "Ispravno je 'aščinica' — nedostaje dijakritički znak 'š' i 'č'"},
            {"id": 48, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Mogu li dobiti jelovnik?", "Molim vas račun.", "Šta preporučujete?", "Željela bih naručiti."]}, "answer": "Željela bih naručiti.", "hint": "Ovo je tačno — ali ako je govornik muškarac, treba 'Želio bih naručiti'"},
            ...
            {"id": 50, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Imam rezervaciju za četvoro.", "Stol je slobodan.", "Plaćam karticom.", "Napojnica je uključena."]}, "answer": "Stol je slobodan.", "hint": "Ispravno — greška je negdje drugdje. Zapravo: 'Plaćam karticom' je tačno, ali 'Plaćam kartice' bi bila greška"},
            ...
            {"id": 53, "type": "find_error_sentence", "instruction": "Koja rečenica sadrži grešku?", "content": {"sentences": ["Za predjelo ću uzeti supu.", "Za glavno jelo naručio sam ćevape.", "Desert je bio odličan.", "Konobar je bio susretljiv."]}, "answer": "Desert je bio odličan.", "hint": "Ispravno je 'Dezert' — ali u bosanskom se piše 'desert' (posuđenica); tačno je 'desert'"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["cjena", "popust", "račun", "kusur"]}, "answer": "cjena", "hint": "Ispravno je 'cijena' — nedostaje slovo 'i' između 'c' i 'jena'"},
            {"id": 39, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["velicina", "boja", "stil", "model"]}, "answer": "velicina", "hint": "Ispravno je 'veličina' — nedostaje dijakritički znak 'č'"},
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["gotovina", "kartica", "cek", "transfer"]}, "answer": "cek", "hint": "Ispravno je 'ček' — nedostaje dijakritički znak 'č'"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["odjeca", "obuća", "nakit", "kapa"]}, "answer": "odjeca", "hint": "Ispravno je 'odjeća' — nedostaje dijakritički znak 'ć'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["koslja", "hlače", "suknja", "jakna"]}, "answer": "koslja", "hint": "Ispravno je 'košulja' — nedostaje dijakritički znak 'š' i slovo 'u' je izbačeno"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["probati", "kupiti", "vrtaiti", "platiti"]}, "answer": "vrtaiti", "hint": "Ispravno je 'vratiti' — slova 'r' i 't' su zamijenjena mjestima"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["skupo", "jeftino", "povoljno", "skupje"]}, "answer": "skupje", "hint": "Ispravno je 'skuplje' — komparativ od 'skupo', nedostaje slovo 'l'"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["kasa", "blagajna", "salter", "izlog"]}, "answer": "salter", "hint": "Ispravno je 'šalter' — nedostaje dijakritički znak 'š'"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["garancija", "reklamacija", "povrat", "zamjana"]}, "answer": "zamjana", "hint": "Ispravno je 'zamjena' — slova 'e' i 'a' su zamijenjena mjestima"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["klijent", "musterija", "kupac", "prodavač"]}, "answer": "musterija", "hint": "Ispravno je 'mušterija' — nedostaje dijakritički znak 'š'"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["visok", "nizak", "mrsav", "debeo"]}, "answer": "mrsav", "hint": "Ispravno je 'mršav' — nedostaje dijakritički znak 'š'"},
            {"id": 39, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["lijep", "ruzan", "simpatičan", "privlačan"]}, "answer": "ruzan", "hint": "Ispravno je 'ružan' — nedostaje dijakritički znak 'ž'"},
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["ljubazan", "susretljiv", "prijatan", "pazljiv"]}, "answer": "pazljiv", "hint": "Ispravno je 'pažljiv' — nedostaje dijakritički znak 'ž'"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["kosa", "oci", "nos", "usta"]}, "answer": "oci", "hint": "Ispravno je 'oči' — nedostaje dijakritički znak 'č'"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["plava", "smeda", "crna", "riđa"]}, "answer": "smeda", "hint": "Ispravno je 'smeđa' — nedostaje dijakritički znak 'đ' umjesto 'd'"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["karakter", "osobnost", "temperament", "narav"]}, "answer": "osobnost", "hint": "Ispravno je 'osobnost' — ovo je hrvatska forma; bosanska forma je 'ličnost'"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["pametan", "mudar", "inteligenta", "bistar"]}, "answer": "inteligenta", "hint": "Ispravno je 'inteligentan' — pogrešan nastavak za muški rod, nedostaje 'n' na kraju"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["stidljiv", "sramezljiv", "introvertiran", "otvoren"]}, "answer": "sramezljiv", "hint": "Ispravno je 'sramežljiv' — nedostaje dijakritički znak 'ž'"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["staromodan", "moderan", "eleganta", "ukusan"]}, "answer": "eleganta", "hint": "Ispravno je 'elegantan' — pogrešan nastavak za muški rod, nedostaje 'n' na kraju"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["brada", "brkovi", "naocale", "frizura"]}, "answer": "naocale", "hint": "Ispravno je 'naočare' — nedostaju dijakritički znakovi 'č'; 'naočale' je hrvatska forma"},
