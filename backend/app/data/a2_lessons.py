...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["naručiti", "konnobar", "jelovnik", "račun"]}, "answer": "konnobar", "hint": "Ispravno je 'konobar' — osoba koja poslužuje u restoranu"},
            {"id": 39, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["predjelo", "glavno jelo", "dezert", "napojnica"]}, "answer": "dezert", "hint": "Ispravno je 'desert' — slatko jelo na kraju"},
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["rezervacija", "specijalitet", "preporuciti", "meni"]}, "answer": "preporuciti", "hint": "Ispravno je 'preporučiti' — sa slovom 'č'"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["ćevapii", "burek", "baklava", "pita"]}, "answer": "ćevapii", "hint": "Ispravno je 'ćevapi' — jedno 'i' na kraju"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["vino", "pivvo", "sok", "mineralnu"]}, "answer": "pivvo", "hint": "Ispravno je 'pivo' — jedno 'v'"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["tanjir", "čaša", "villjuška", "nož"]}, "answer": "villjuška", "hint": "Ispravno je 'viljuška' — pribor za jelo"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["sladak", "slan", "kiseloo", "gorak"]}, "answer": "kiseloo", "hint": "Ispravno je 'kiseo' — okus limuna ili jogurta"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["hladna", "topla", "vruuća", "svježa"]}, "answer": "vruuća", "hint": "Ispravno je 'vruća' — jako topla"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["čorba", "supa", "juhha", "varivo"]}, "answer": "juhha", "hint": "Ispravno je 'juha' — tečno jelo"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["kuhinja", "restoran", "aščinica", "kafanna"]}, "answer": "kafanna", "hint": "Ispravno je 'kafana' — tradicionalni restoran s pićem"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["cijena", "popusst", "račun", "kusur"]}, "answer": "popusst", "hint": "Ispravno je 'popust' — sniženje cijene"},
            {"id": 39, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["veličina", "boja", "stil", "modeell"]}, "answer": "modeell", "hint": "Ispravno je 'model' — dizajn ili vrsta"},
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["gotovina", "kartica", "čekk", "transfer"]}, "answer": "čekk", "hint": "Ispravno je 'ček' — vrsta plaćanja"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["odjeća", "obuuća", "nakit", "kapa"]}, "answer": "obuuća", "hint": "Ispravno je 'obuća' — cipele i slično"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["košulja", "hlačče", "suknja", "jakna"]}, "answer": "hlačče", "hint": "Ispravno je 'hlače' — duge pantalone"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["probati", "kupiti", "vraciti", "platiti"]}, "answer": "vraciti", "hint": "Ispravno je 'vratiti' — sa 't' i dijakritičkim znakom na 'ć': 'vratiti'"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["skupo", "jeftinno", "povoljno", "skuplje"]}, "answer": "jeftinno", "hint": "Ispravno je 'jeftino' — nije skupo"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["kasa", "blagajjna", "šalter", "izlog"]}, "answer": "blagajjna", "hint": "Ispravno je 'blagajna' — mjesta za plaćanje"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["garancija", "reklamaccia", "povrat", "zamjena"]}, "answer": "reklamaccia", "hint": "Ispravno je 'reklamacija' — prigovor na robu"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["klijent", "mušterija", "kupac", "prodavvač"]}, "answer": "prodavvač", "hint": "Ispravno je 'prodavač' — osoba koja prodaje"},
...
""",
        ...
        "exercises": [
            ...
            {"id": 38, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["visok", "nizakk", "mršav", "debeo"]}, "answer": "nizakk", "hint": "Ispravno je 'nizak' — nije visok"},
            {"id": 39, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["lijep", "ružan", "simpatičan", "privllačan"]}, "answer": "privllačan", "hint": "Ispravno je 'privlačan' — atraktivan"},
            {"id": 40, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["ljubazan", "susretljiv", "prijatteljan", "pažljiv"]}, "answer": "prijatteljan", "hint": "Ispravno je 'prijatan' ili 'prijatan' — prijatan za ophođenje"},
            {"id": 41, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["kosa", "oči", "nos", "ussta"]}, "answer": "ussta", "hint": "Ispravno je 'usta' — organ za govor i jelo"},
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["plava", "smedja", "crna", "riđa"]}, "answer": "smedja", "hint": "Ispravno je 'smeđa' — tamno smeđa boja"},
            {"id": 43, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["karakterr", "osobnost", "temperament", "narav"]}, "answer": "karakterr", "hint": "Ispravno je 'karakter' — jedno 'r' na kraju"},
            {"id": 44, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["pametan", "muudar", "inteligentan", "bistro"]}, "answer": "muudar", "hint": "Ispravno je 'mudar' — ima životno iskustvo"},
            {"id": 45, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["stidljiv", "sramezljiv", "introvertiran", "otvvoren"]}, "answer": "otvvoren", "hint": "Ispravno je 'otvoren' — druželjubiva osoba"},
            {"id": 46, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["staromodan", "moderan", "elegantan", "ukusaan"]}, "answer": "ukusaan", "hint": "Ispravno je 'ukusan' — u smislu stila: dobra ukusa"},
            {"id": 47, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["brada", "brkovi", "naočarre", "frizura"]}, "answer": "naočarre", "hint": "Ispravno je 'naočare' — optičko pomagalo"},
