...
""",
        ...
        "exercises": [
            ...
            {"id": 42, "type": "find_error_word", "instruction": "Pronađite pogrešno napisanu ili pogrešno upotrebljenu riječ", "content": {"words": ["vino", "pivo", "sok", "minerlana"]}, "answer": "minerlana", "hint": "Ispravno je 'mineralna' — slova su zamijenjena: 'rl' treba biti 'ral'"},
